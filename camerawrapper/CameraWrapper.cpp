...
{
    ALOGD("%s->%08X->%08X", __FUNCTION__, (uintptr_t)device, (uintptr_t)(((wrapper_camera_device_t*)device)->vendor));
                ...
                hw_device_t** device)
{
    ...
    if (name != NULL) {
        ...
        ALOGD("%s: got vendor camera device 0x%08X", __FUNCTION__, (uintptr_t)(camera_device->vendor));
